...
\usepackage[acronym, nonumberlist, toc, section]{glossaries} % NEU: Paket für Glossar und Abkürzungen
\makeglossaries                                     % NEU: Befehl, um die Verzeichnisse zu erstellen
\usepackage{chngcntr}
